...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  "learning.view": "View Development Records",
  "learning.manage": "Manage Development Records",
  "training.view": "View Training Management",
  "training.manage": "Manage Training Records",
  "succession.view": "View Career and Succession Profiles",
  "succession.manage": "Maintain Career and Succession Profiles",
  "recognition.view": "View Social Recognition",
  "recognition.manage": "Review Social Recognition",
...
export const CANONICAL_EVALUATION_SEQUENCE = [
  "EMPLOYEE_SUBMITTED",
  "SUPERVISOR_DRAFT",
...
export const CANONICAL_STAGE_TRANSITIONS: Partial<Record<EvaluationStatus, EvaluationStatus[]>> = {

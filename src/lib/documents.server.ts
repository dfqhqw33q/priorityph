  ...
  <style>
    @media print {
      * { margin: 0; padding: 0; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
      ...
      body { font-family: Arial, sans-serif; font-size: 11px; zoom: 0.9; }
      .container { max-width: 100%; }
    }
    * { box-sizing: border-box; }
    body { font-family: Arial, sans-serif; color: #1a1a1a; background: white; margin: 0; padding: 20px; font-size: 11px; }
    ...
    .title h1 { font-size: 13px; font-weight: bold; text-transform: uppercase; margin: 0; }
    .title h2 { font-size: 11px; font-weight: bold; text-transform: uppercase; margin: 4px 0 0 0; }
    
    .period-covered { display: flex; align-items: center; gap: 8px; margin-bottom: 8px; flex-wrap: wrap; }
    .period-covered span { font-size: 9px; font-weight: 600; white-space: nowrap; }
    .period-covered .input { flex: 1; min-width: 120px; border: none; border-bottom: 1px solid #000; text-align: center; font-size: 10px; padding: 3px 6px; }
    ...
    .info-field .value { flex: 1; border: none; border-bottom: 1px solid #000; font-size: 10px; padding: 3px 6px; word-wrap: break-word; }
    
    .rating-scale { border: 1px solid #000; padding: 5px 7px; margin-bottom: 8px; display: flex; flex-wrap: wrap; justify-content: space-between; gap: 6px; font-weight: 600; font-size: 9px; }
    
    .table-container { margin-bottom: 8px; }
    table { width: 100%; border-collapse: collapse; font-size: 9px; }
    thead tr { background-color: transparent; }
    th { border: 1px solid #000; padding: 3px 2px; text-align: center; font-weight: bold; text-transform: uppercase; font-size: 8px; color: #1a1a1a; background-color: transparent; }
    td { padding: 3px 3px; }
    
    .signatures { display: flex; margin-bottom: 8px; }
    ...
    .conclusions h3 { text-align: center; font-size: 11px; font-weight: bold; text-transform: uppercase; margin-bottom: 8px; }
    .conclusions h4 { font-size: 11px; font-weight: bold; margin: 8px 0; }
    .conclusions p { font-size: 11px; margin: 4px 0; }
    .conclusions .question { margin-bottom: 8px; }
    .question-content { border: none; border-bottom: 1px solid #000; min-height: 24px; padding: 4px 8px; font-size: 11px; margin-bottom: 8px; word-wrap: break-word; }
    ...
    .step-two { margin-top: 12px; font-family: Arial, sans-serif; font-size: 10px; line-height: 1.2; }
    @media print {
      .step-two {
    ...
    .step-three { margin-top: 12px; font-family: Arial, sans-serif; font-size: 10px; line-height: 1.15; }

    ...
    <div className="space-y-6">
      ...
      <div className="max-w-full border border-border bg-card shadow-sm">
        <Table>
          ...
          <TableHeader>
            <TableRow>
              <TableHead className="min-w-[120px] whitespace-nowrap bg-primary text-primary-foreground dark:bg-muted/60 dark:text-foreground">
                Employee ID
              </TableHead>
              <TableHead className="min-w-[190px] bg-primary text-primary-foreground dark:bg-muted/60 dark:text-foreground">
                Full Name
              </TableHead>
              <TableHead className="min-w-[150px] bg-primary text-primary-foreground dark:bg-muted/60 dark:text-foreground">
                Job Title
              </TableHead>
              ...
              <TableHead className="min-w-[240px] bg-primary text-primary-foreground dark:bg-muted/60 dark:text-foreground">
                Cycle
              </TableHead>
              <TableHead className="min-w-[190px] whitespace-nowrap bg-primary text-primary-foreground dark:bg-muted/60 dark:text-foreground">
                Date Submitted
              </TableHead>
              <TableHead className="min-w-[120px] whitespace-nowrap bg-primary text-primary-foreground dark:bg-muted/60 dark:text-foreground">
                Status

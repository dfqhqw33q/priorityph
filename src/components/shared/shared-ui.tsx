...
const EVAL_VARIANTS: Record<EvaluationStatus, string> = {
  ...
  SUBMITTED: "border-sky-500/20 bg-sky-500/10 text-sky-700 dark:bg-sky-500/20 dark:text-sky-300 font-medium",
  FOR_REVIEW: "border-violet-500/20 bg-violet-500/10 text-violet-700 dark:bg-violet-500/20 dark:text-violet-300 font-medium",
  FOR_PROCESSING: "border-cyan-500/20 bg-cyan-500/10 text-cyan-700 dark:bg-cyan-500/20 dark:text-cyan-300 font-medium",
  FOR_APPROVAL: "border-fuchsia-500/20 bg-fuchsia-500/10 text-fuchsia-700 dark:bg-fuchsia-500/20 dark:text-fuchsia-300 font-medium",
  RETURNED: "border-rose-500/20 bg-rose-500/10 text-rose-700 dark:bg-rose-500/20 dark:text-rose-300 font-medium",
